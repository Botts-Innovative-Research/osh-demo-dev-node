 ...
 * @since 05/23/2024
 */
public class UniversalControllerOutput extends VarRateSensorOutput<UniversalControllerSensor> implements Runnable {
    ...
    UniversalControllerOutput(UniversalControllerSensor parentSensor) {
        super(SENSOR_OUTPUT_NAME, parentSensor, parentSensor.getConfiguration().pollingRate/1000d);
    }
