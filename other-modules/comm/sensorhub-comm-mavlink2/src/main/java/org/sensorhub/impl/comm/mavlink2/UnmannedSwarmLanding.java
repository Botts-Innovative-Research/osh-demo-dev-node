 ...
 * @since Jul 2025
 */
public class UnmannedSwarmLanding extends AbstractSensorControl<UnmannedSwarm>
{
     ...
     * Name of the control
     */
    private static final String SENSOR_CONTROL_NAME = "UnmannedSwarmLanding";

    /**
     * Label for the control
     */
    private static final String SENSOR_CONTROL_LABEL = "Swarm Landing Control";

    /**
     * Control description
     */
    private static final String SENSOR_CONTROL_DESCRIPTION =
            "Interfaces with MAVLINK and OSH to effectuate landing control over the swarm";

    /**
     * ROS Node name assigned at creation
     */
    private static final String NODE_NAME_STR = "/SensorHub/spot/swarm_landing_control";

    private io.mavsdk.System system = null;

    static double deltaSuccess =   0.000003; //distance from lat/lon to determine success

    public UnmannedSwarmLanding( UnmannedSwarm parentSensor) {
        super("mavSwarmLandingControl", parentSensor);
    }
    ...
    public void init() {
        ...
        commandDataStruct = factory.createRecord()
                ...
                .addField("disarm", factory.createBoolean().value(true).build())
                .build();
    }
    ...
    protected boolean execCommand(DataBlock command) throws CommandException {
        ...
        for (var subsystem : parent.getMembers().values()) {
            ...
            if (subsystem instanceof UnmannedSystem) {
                var input = (UnmannedControlLanding)((UnmannedSystem) subsystem).getCommandInputs().get("mavLandingControl");
                if ( null != input ) {
